...
std::string install_su(const char* str_root_key, const char* base_path, ssize_t & err, const char* su_hide_folder_head_flag = "su");

std::string safe_install_su(const char* str_root_key, const char* base_path, ssize_t& err, const char* su_hide_folder_head_flag = "su");
