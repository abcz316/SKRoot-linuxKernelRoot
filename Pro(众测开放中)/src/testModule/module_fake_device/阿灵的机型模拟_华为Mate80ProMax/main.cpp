...
int skroot_module_main(const char* root_key, const char* module_private_dir) {
    printf("*******************************\n");
    printf(" 全局模拟机型：华为 Mate 80 Pro Max\n");
    printf("   阿灵\n");
    printf("*******************************\n");
    pid_t pid = ::fork();
    if (pid == 0) {
...
// SKRoot 模块名片
SKROOT_MODULE_NAME("阿灵的机型模拟 华为 Mate 80 Pro Max")
SKROOT_MODULE_VERSION("5.2.0")
SKROOT_MODULE_DESC("全局机型模拟为华为 Mate 80 Pro Max，TG频道:@Whitelist520")
SKROOT_MODULE_AUTHOR("阿灵")
SKROOT_MODULE_UUID32("mznMiXB7H5RCBUldFMKagfFwzzdrm711")
SKROOT_MODULE_ON_INSTALL(module_on_install)
SKROOT_MODULE_UPDATE_JSON("https://abcz316.github.io/SKRoot-linuxKernelRoot/module_fake_device/aling_huaweiMate80ProMax_update.json")