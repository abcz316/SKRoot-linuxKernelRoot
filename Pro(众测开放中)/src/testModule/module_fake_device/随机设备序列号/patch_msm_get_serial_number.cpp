...
PatchMsmGetSerialNumber::PatchMsmGetSerialNumber(const PatchBase& patch_base, uint64_t msm_get_serial_number) : PatchBase(patch_base), m_msm_get_serial_number(msm_get_serial_number) {}

PatchMsmGetSerialNumber::~PatchMsmGetSerialNumber() {}
...
*/
KModErr PatchMsmGetSerialNumber::patch_msm_get_serial_number(const std::string& fake_soc_sn) {
	GpX x1_attr = x1;
	GpX x2_buf = x2;
	...
	return patch_kernel_before_hook(m_msm_get_serial_number, a);
}