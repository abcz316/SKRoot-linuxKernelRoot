...
// SKRoot 模块名片
SKROOT_MODULE_NAME("阿灵的机型模拟 一加15")
SKROOT_MODULE_VERSION("5.2.0")
SKROOT_MODULE_DESC("全局机型模拟为一加15，TG频道:@Whitelist520")
SKROOT_MODULE_AUTHOR("阿灵")
SKROOT_MODULE_UUID32("evq0GG8tdzT5dki8Be84aULan31w6tH6")
SKROOT_MODULE_ON_INSTALL(module_on_install)
SKROOT_MODULE_UPDATE_JSON("https://abcz316.github.io/SKRoot-linuxKernelRoot/module_fake_device/aling_oneplus15_update.json")