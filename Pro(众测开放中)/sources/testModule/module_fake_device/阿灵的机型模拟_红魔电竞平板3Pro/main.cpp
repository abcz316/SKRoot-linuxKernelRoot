...
// SKRoot 模块名片
SKROOT_MODULE_NAME("阿灵的机型模拟 红魔电竞平板3 Pro")
SKROOT_MODULE_VERSION("5.2.0")
SKROOT_MODULE_DESC("全局机型模拟为红魔电竞平板3 Pro，TG频道:@Whitelist520")
SKROOT_MODULE_AUTHOR("阿灵")
SKROOT_MODULE_UUID32("6lkERo1vmLxcFVYz6TYcagYoJPlAwSql")
SKROOT_MODULE_ON_INSTALL(module_on_install)
SKROOT_MODULE_UPDATE_JSON("https://abcz316.github.io/SKRoot-linuxKernelRoot/module_fake_device/aling_nubiaPad3pro_update.json")