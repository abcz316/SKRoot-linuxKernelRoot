...
public class SelectFileRecyclerAdapter extends RecyclerView.Adapter<SelectFileRecyclerAdapter.ViewHolder> {
    ...
    private List<SelectFileItem> objects;
    private PopupWindow popupWindow;
    private Handler selectFileCallback;
    private Context ctx;
    public SelectFileRecyclerAdapter(Context ctx, int textViewResourceId, List<SelectFileItem> objects, PopupWindow popupWindow, Handler selectFileCallback) {
    ...
    public void updateList(List<SelectFileItem> newList) {
        objects.clear();
    ...
    public List<SelectFileItem> getList() {
        return objects;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SelectFileItem fileItem=objects.get(position);
    ...
    class ClickRecyclerItemListener implements View.OnClickListener {
        ...
        public ClickRecyclerItemListener(SelectFileItem fileItem){
        ...
        public void onClick(View v) {
            ...
            msg.obj = (SelectFileItem)fileItem;
